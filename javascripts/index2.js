...
const displayFavorite = (brewery) => {
    ...
    deleteButtonEvent(document.getElementById(`delete${brewery.id}`), brewery);
...
*/
    ...
    // delBtn = createButton("Remove", `delete${brewery.id}`, "delete");
    // btns.append(delBtn);
    btns.innerHTML = ` <a class="waves-effect waves-light btn modal-trigger" data-target="edit${brewery.id}"><i class="material-icons left">edit</i>Edit</a>
                       <button class="waves-effect waves-light btn" id="delete${brewery.id}"><i class="material-icons left">delete</i>Remove</button>`
